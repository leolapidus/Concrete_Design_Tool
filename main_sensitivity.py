...
from Sensitivity.steepest_descent import steepest_descent_as
from Sensitivity.steepest_descent_m import steepest_descent_m
...
model.add_dirichlet_condition(dof=(4, 'v'), value=0)
...
#steepest_descent_as(model, b0, h0, younges_modulus, concrete_type, expositionclass, 'table')
